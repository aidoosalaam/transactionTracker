...
import com.clickcharm.transactoinapi.services.UserService;
...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String ,String>> loginUser(@RequestBody Map<String,Object> loginMapReq){
        String email = (String) loginMapReq.get("email");
        String password = (String) loginMapReq.get("password");
    ...
    public ResponseEntity<Map<String,String>> registerUser(@RequestBody Map<String,Object> userRequest){
        ...
        User user = userService.registerUser(new User(firstName,lastName,email,password));
        return new ResponseEntity<>(generateJWTToken(user), HttpStatus.OK);
    }
